    ...
    private void registerMenu() {
        ...
        switch (sin.nextInt()) {
            case 1:
                ...
                List<Course> studentCourses = studentService.getStudentCourses(currentStudent.getStudentByEmail());
                ...
                if (newCourse != null) {
                    studentService.registerStudentToCourse(currentStudent.getStudentByEmail(), newCourse);
                    Student temp = studentService.getStudentByEmail(currentStudent.getStudentByEmail()).get(0);

                    StudentService scService = new StudentService();
                    List<Course> sCourses = scService.getAllCourses(temp.getStudentByEmail());
